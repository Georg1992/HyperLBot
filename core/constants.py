...
class VariabilityConstants:
    ...
    VOLATILITY_5M_LOW = 0.001         # 0.1% - low movement (quiet market, small moves)
    VOLATILITY_5M_MODERATE = 0.002    # 0.2% - moderate movement (normal trading, noticeable moves)
    VOLATILITY_5M_HIGH = 0.0035       # 0.35% - high movement (active trading, significant moves)
    VOLATILITY_5M_EXTREME = 0.008     # 0.8% - extreme movement (volatile market, large moves)
