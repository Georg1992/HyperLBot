...
class VariabilityConstants:
    ...
    VOLATILITY_5M_LOW = 0.0018        # 0.18% - low movement (quiet market, small moves)
    VOLATILITY_5M_MODERATE = 0.0025   # 0.25% - moderate movement (normal trading, noticeable moves)
