#!/usr/bin/env python3
"""
Hyperliquid API Analysis Module
Contains market analysis methods extracted from hyperliquid_api.py
"""
...
class HyperliquidAnalysis:
    """Market analysis methods for Hyperliquid API"""
